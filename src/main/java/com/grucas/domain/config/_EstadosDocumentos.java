...
public class _EstadosDocumentos {
    ...
    public static final List<String> ESTADOS_PREVIO = Arrays.asList(ESTADO_TODOS,ESTADO_DOCUMENTO_PRE_ELABORADO,ESTADO_DOCUMENTO_TERMINADO,ESTADO_CANCELADO);
    public static final List<String> ESTADOS_RESPONSIVA = Arrays.asList(ESTADO_ACTIVO,ESTADO_CANCELADO,ESTADO_DOCUMENTO_PRE_ELABORADO,ESTADO_DOCUMENTO_TERMINADO);
