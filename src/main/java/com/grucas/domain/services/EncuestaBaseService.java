...
public class EncuestaBaseService {
    ...
    public void getEncuestaBaseCliente(String where, String group, String order){

        dao.getEncuestaBaseCliente(where, group, order);
      ...
      public void getEncuestaComplementoCliente(String where, String group, String order){

        dao.getEncuestaComplementoCliente(where, group, order);
