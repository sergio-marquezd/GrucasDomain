...
public class VendedorDAO {
    ...
    private List<Vendedor> objects = null;
    private Vendedor object = null;
    private Boolean ok = false;
    private Integer err_code = 0;
    private final SqlSessionFactory sqlSessionFactory;

    public VendedorDAO(String env) {
    ...
    public void getVendedorID(){
        ...
        try {
            ...
            id = session.selectOne("VendedorMaxID");
    ...
    public void getVendedor(String strWhere, String strGroup, String strOrder){
        ...
        try {
            ...
            session = sqlSessionFactory.openSession();
            objects = session.selectList("VendedorWhere",map);
    ...
    public void getOneVendedor(String strWhere){
        ...
        try {
            ...
            session = sqlSessionFactory.openSession();
            object = session.selectOne("VendedorWhere",map);
    ...
    public void VendedorInsert(Vendedor object) {
        ...
        try {
            ...
            session = sqlSessionFactory.openSession();
            session.insert("VendedorInsert", object);
            session.commit();
            ok = true;
    ...
    public void VendedorUpdate(Vendedor object){
        ...
        try {
            ...
            session = sqlSessionFactory.openSession();
            session.update("VendedorUpdate",object);
            session.commit();
    ...
    public void VendedorDelete(Integer id){
        ...
        try {
            ...
            session = sqlSessionFactory.openSession();
            session.delete("VendedorDelete",id);
            session.commit();
