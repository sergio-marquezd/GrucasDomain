...
public class ProductoServicioDAO {
    ...
    private List<ProductoServicio> objects = null;
    private ProductoServicio object = null;
    private Boolean ok = false;
    private Integer err_code = 0;
    private final SqlSessionFactory sqlSessionFactory;

    public ProductoServicioDAO(String env) {
    ...
    public void getProductoID(){
        ...
        try {
            ...
            id = session.selectOne("ProductoServicioMaxID");
    ...
    public void getProducto(String strWhere, String strGroup, String strOrder){
        ...
        try {
            ...
            session = sqlSessionFactory.openSession();
            objects = session.selectList("ProductoServicioWhere",map);
    ...
    public void getOneProducto(String strWhere){
        ...
        try {
            ...
            session = sqlSessionFactory.openSession();
            object = session.selectOne("ProductoServicioWhere",map);
    ...
    public void ProductoInsert(ProductoServicio object) {
        ...
        try {
            ...
            session = sqlSessionFactory.openSession();
            session.insert("ProductoServicioInsert", object);
            session.commit();
            ok = true;
    ...
    public void ProductoUpdate(ProductoServicio object){
        ...
        try {
            ...
            session = sqlSessionFactory.openSession();
            session.update("ProductoServicioUpdate",object);
            session.commit();
    ...
    public void ProductoDelete(Integer id){
        ...
        try {
            ...
            session = sqlSessionFactory.openSession();
            session.delete("ProductoServicioDelete",id);
            session.commit();
