...
public class PuestoDAO {
    ...
    private List<Puesto> objects = null;
    private Puesto object = null;
    private Boolean ok = false;
    private Integer err_code = 0;
    private final SqlSessionFactory sqlSessionFactory;

    public PuestoDAO(String env) {
    ...
    public void getPuestoID(){
        ...
        try {
            ...
            id = session.selectOne("PuestoMaxID");
    ...
    public void getPuesto(String strWhere, String strGroup, String strOrder){
        ...
        try {
            ...
            session = sqlSessionFactory.openSession();
            objects = session.selectList("PuestoWhere",map);
    ...
    public void getOnePuesto(String strWhere){
        ...
        try {
            ...
            session = sqlSessionFactory.openSession();
            object = session.selectOne("PuestoWhere",map);
    ...
    public void PuestoInsert(Puesto object) {
        ...
        try {
            ...
            session = sqlSessionFactory.openSession();
            session.insert("PuestoInsert", object);
            session.commit();
            ok = true;
    ...
    public void PuestoUpdate(Puesto object){
        ...
        try {
            ...
            session = sqlSessionFactory.openSession();
            session.update("PuestoUpdate",object);
            session.commit();
    ...
    public void PuestoDelete(Integer id){
        ...
        try {
            ...
            session = sqlSessionFactory.openSession();
            session.delete("PuestoDelete",id);
            session.commit();
