...
public class CodigoBarrasDAO {
    ...
    private List<CodigoBarras> objects = null;
    private CodigoBarras object = null;
    private Boolean ok = false;
    private Integer err_code = 0;
    private final SqlSessionFactory sqlSessionFactory;

    public CodigoBarrasDAO(String env) {
    ...
    public void getCodigoBarrasID(){
        ...
        try {
            ...
            id = session.selectOne("CodigoBarrasMaxID");
    ...
    public void getCodigoBarras(String strWhere, String strGroup, String strOrder){
        ...
        try {
            ...
            session = sqlSessionFactory.openSession();
            objects = session.selectList("CodigoBarrasWhere",map);
    ...
    public void getOneCodigoBarras(String strWhere){
        ...
        try {
            ...
            session = sqlSessionFactory.openSession();
            object = session.selectOne("CodigoBarrasWhere",map);
    ...
    public void CodigoBarrasInsert(CodigoBarras object) {
        ...
        try {
            ...
            session = sqlSessionFactory.openSession();
            session.insert("CodigoBarrasInsert", object);
            session.commit();
            ok = true;
    ...
    public void CodigoBarrasUpdate(CodigoBarras object){
        ...
        try {
            ...
            session = sqlSessionFactory.openSession();
            session.update("CodigoBarrasUpdate",object);
            session.commit();
    ...
    public void CodigoBarrasDelete(Integer id){
        ...
        try {
            ...
            session = sqlSessionFactory.openSession();
            session.delete("CodigoBarrasDelete",id);
            session.commit();
