 ...
 * @author User
 */
public class ClienteAduanasDAO {
    private Integer id = 0;
    private List<ClienteAduanas> objects = null;
    private ClienteAduanas object = null;
    private Boolean ok = false;
    private Integer err_code = 0;
    private final SqlSessionFactory sqlSessionFactory;
    
  public ClienteAduanasDAO(String env) {
    ...
    public void getClienteAduanasID(){
        ...
        try {
            ...
            id = session.selectOne("ClienteAdunasMaxID");
    ...
    public void getClienteAduanas(String strWhere, String strGroup, String strOrder){
        ...
        try {
            ...
            session = sqlSessionFactory.openSession();
            objects = session.selectList("ClienteAduanasWhere",map);
    ...
    public void getOneClienteAduanas(String strWhere){
        ...
        try {
            ...
            session = sqlSessionFactory.openSession();
            object = session.selectOne("ClienteAduanasWhere",map);
    ...
    public void ClienteAduanasInsert(ClienteAduanas object) {
        ...
        try {
            ...
            session = sqlSessionFactory.openSession();
            session.insert("ClienteAduanasInsert", object);
            session.commit();
            ok = true;
    ...
    public void ClienteAdunasUpdate(ClienteAduanas object){
    ...
    public void ClienteAdunasDelete(Integer id){
        ...
        try {
            ...
            session = sqlSessionFactory.openSession();
            session.delete("ClienteAduanasDelete",id);
            session.commit();
